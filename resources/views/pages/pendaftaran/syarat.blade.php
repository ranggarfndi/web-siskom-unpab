        ...
        <div class="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16 text-center">
                <div class="inline-block bg-purple-50 border border-purple-200 rounded-xl p-6">
                    ...
                    <a href="{{ route('pendaftaran.prosedur') }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-purple-700 hover:bg-purple-800 transition duration-150 ease-in-out shadow-md">
