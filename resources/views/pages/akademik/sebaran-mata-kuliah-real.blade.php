                            ...
                            <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    @foreach($courses as $index => $course)
                                        @php
                                            // Tentukan status Wajib (W) atau Pilihan (P)
                                            $status = in_array($course['nama'], $listPilihan) ? 'P' : 'W';
                                            
                                            // Hitung SKS ke variabel Global
                                            if ($status === 'W') {
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-bold {{ $status === 'P' ? 'text-orange-600' : 'text-green-600' }}">
                                                {{ $status }}
                                            </td>
