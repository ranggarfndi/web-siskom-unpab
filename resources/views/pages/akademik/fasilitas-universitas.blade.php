    <x-app-layout>
        ...
        <div class="bg-gray-50">
            <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 text-center">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900">Fasilitas Universitas</h1>
                <p class="mt-3 text-lg text-gray-600 max-w-2xl mx-auto">Menunjang seluruh kegiatan akademik dan non-akademik civitas akademika UNPAB.</p>
            </div>
        </div>
            ...
            <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                @else
                    <div class="text-center py-12">
                        <p class="text-gray-500 text-xl">Belum ada data fasilitas universitas yang ditambahkan.</p>
                    </div>
                @endif
            </div>
        </div>
